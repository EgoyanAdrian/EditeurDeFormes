...
MenuOutils::MenuOutils(uint _x,uint _y,uint _mousex, uint _mousey,bool isPushLeft,sf::RenderWindow &w){
	...
	//stock les rectangles dans un tableau de formes
	BarreOutil.ajouter(dessinRectan);
	//BarreOutil.ajouter(dessinCarre);
	//BarreOutil.ajouter(dessinPoint);
