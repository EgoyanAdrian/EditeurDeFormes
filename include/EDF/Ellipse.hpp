...
template <typename ...> class Ellipse<WindowT, ColorT>;
...
:Ellipse<WindowT, ColorT>(_origin.getAnchor()->getX(), _origin.getAnchor()->getY(), _origin.getWidth(), _origin.getHeight(), _origin.getColor())
{ }
